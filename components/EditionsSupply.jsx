...
import S from '../styles/EditionsSupply.module.scss'
import frame from '../public/assets/EditionsSupply/Vector 19.svg'
...
import edition2_2 from '../public/assets/EditionsSupply/edition 2 1.jpg'
import edition3 from '../public/assets/EditionsSupply/edition 3 1.jpg'
import edition4 from '../public/assets/EditionsSupply/edition 4 1.jpg'
      ...
      <div className={S.container}>
        ...
        <div className={S.content}>
          <div className={S.frame}>
            ...
            <Image src={frame} width='1016' height='680' />
          </div>
          <div className={S.edition1}>
            <div className={S.bg}>
              <Image src={edition1} width='186' height='144' />
              <h4 className={S.bg_text}>Edition 1</h4>
            </div>
            <div className={S.animation}>
              <Image src={anim1} width='340' height='340' />
            </div>
          ...
          <div className={S.edition2}>
            ...
            <div className={S.bg2_1}>
              <Image src={edition2_1} width='108' height='108' />
            </div>
            <div className={S.bg2_2}>
              <Image src={edition2_2} width='289' height='192' />
              <h4 className={S.bg_text}>Edition 2</h4>
            </div>
            <div className={S.animation}>
              <Image src={anim2} width='340' height='340' />
            </div>
          </div>
          <div className={S.edition3}>
            <div className={S.bg_white} />
            <div className={S.bg}>
              <Image src={edition3} width='219' height='197' />
              <h4 className={S.bg_text}>Edition 3</h4>
            </div>
            <div className={S.animation}>
              <Image src={anim3} width='345' height='345' />
            </div>
            <div className={S.textarea}>
          ...
          <div className={S.edition4}>
            ...
            <div className={S.bg}>
              <Image src={edition4} width='221' height='183' />
              <h4 className={S.bg_text}>Edition 4</h4>
            </div>
            <div className={S.animation}>
              <Image src={anim4} width='439' height='247' />
            </div>
          </div>
