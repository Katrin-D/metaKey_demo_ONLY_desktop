...
import S from '../../styles/mobile/FAQs.module.scss'
      ...
      <div className={S.questions}>
        ...
        <div className={S.question}>
          ...
          <p>
            ...
            integrations and drops; a different level of scarcity; and occasional Edition-exclusive benefits offered by
            the Edition artist/s.
          </p>
        </div>
        <div className={S.question}>
