...
import S from '../styles/BrandCases.module.scss'
    ...
    <div className={S.main}>
      <div className={S.container}>
        ...
        <div className={S.section2}>
          ...
          <p className={S.text}>
            Metakey-holders were exclusively whitelisted for an early minting of the AO Art Ball NFTs— a groundbreaking
            new way for fans to engage with spectator sport in real time.
          </p>
        ...
        <div className={S.section3}>
          ...
          <p className={S.text}>Key-holders will soon be able to earn by contributing to this "MetaKamp" collection!</p>
        </div>
        <div className={S.section4}>
          ...
          <p className={S.text}>
            As Sandbox neighbours, we're working on collaborative experiences to that end. You may spot some VX Kongz in
            the wild sporting a handsome Metakey uniform to celebrate our friendship!
          </p>
        </div>
        ...
        <div className={S.section6}>
          ...
          <h2 className={S.title}>SIR JACKIE STEWART (1969 Formula 1 Driver)</h2>
          <div className={S.read_more}>
            <div className={S.plusIcon} />
            <p>READ MORE</p>
          </div>
          <p className={S.text}>
            ...
            dropped exclusively to Metakey holders as a Decentraland wearable and one of the first official Formula One
            driver NFTs, in June 2021.
          </p>
        </div>
      </div>
    </div>
